...
/**
 * Get all sub-attributes of the provided attribute. Retrieve list that contains instantiated
 * attribute from definition.
...
/**
 * Emit event to the parent to delete wanted attribute.
 */
