<template>
  ...
  >
    ...
    <div class="flex row items-center justify-center">
      ...
      >
        <template #loading>
          <q-spinner-bars class="q-mr-md" />
          <label>
            {{ $t('actions.default.ia')}}
          </label>
        </template>
      </q-btn>
    </div>
...
import { createDiagram } from 'src/services/IAService';
...
async function onSubmit() {
  ...
  const files = await createDiagram(modelPlugin.value, modelDescription.value);
