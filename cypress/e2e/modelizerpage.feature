Feature: Test modelizer page
  ...
  Scenario: Set git configuration for a project
    ...
    Then I expect button "[data-cy=\"git-form\"] [data-cy=\"git-form-submit\"]" stop loading
    And I expect "positive" toast to appear with text "We have access to your repository 🥳!"
