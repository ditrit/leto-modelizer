Feature: Test git settings dialog
  ...
  Scenario: Each project should have its own value of git settings
    ...
    When I set on "[data-cy=\"git-form\"] [data-cy=\"git-repository-input\"]" text "https://github.com/ditrit/leto-modelizer-plugin-core"
    And I set on "[data-cy=\"git-form\"] [data-cy=\"git-username-input\"]" text "test2"
    And I set on "[data-cy=\"git-form\"] [data-cy=\"git-token-input\"]" text "test2"
    And I click on "[data-cy=\"git-form\"] [data-cy=\"git-form-submit\"]"
    Then I expect "positive" toast to appear with text "We have access to your repository 🥳!"
    And I expect "[data-cy=\"git-form\"]" is closed
    ...
    And I click on "[data-cy=\"project-settings\"]"
    And I click on "[data-cy=\"git-settings-menu\"]"
    Then I expect field "[data-cy=\"git-form\"] [data-cy=\"git-repository-input\"]" is "https://github.com/ditrit/leto-modelizer-project-test"
    And I expect field "[data-cy=\"git-form\"] [data-cy=\"git-username-input\"]" is "test"
    And I expect field "[data-cy=\"git-form\"] [data-cy=\"git-token-input\"]" is "test"
