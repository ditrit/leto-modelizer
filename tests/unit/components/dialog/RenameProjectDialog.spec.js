...
import RenameProjectDialog from 'src/components/dialog/RenameProjectDialog';
...
describe('Test component: RenameProjectDialog', () => {
  let wrapper;
  let subscribe;
  let unsubscribe;
  ...
  beforeEach(() => {
    ...
    wrapper = shallowMount(RenameProjectDialog, {
      global: {
        plugins: [
  ...
  describe('Test function: setProjectId', () => {
    it('should set projectId on valid event key', () => {
      ...
      wrapper.vm.setProjectId({ id: 'test', key: 'RenameProject' });
