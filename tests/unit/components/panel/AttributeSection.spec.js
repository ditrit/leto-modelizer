...
describe('test component: AttributeSection', () => {
  ...
  describe('Test function: getSubAttributes', () => {
    ...
    it('should return empty attributes array on attribute without definition and value is undefined ', () => {
    ...
    it('should return an array with instantiate defined attribute with its value even if value is undefined', () => {
      expect(wrapper.vm.getSubAttributes({
        value: [],
        definition: {
          definedAttributes: [{
    ...
    it('should return an array with instantiate defined attribute with its value even if value is defined', () => {
      expect(wrapper.vm.getSubAttributes({
        value: [{
          ...defaultAttribute,
          value: 'toto',
    ...
    it('should return instantiate attribute with its value even if definition does not exists', () => {
      expect(wrapper.vm.getSubAttributes({
        value: [{
          ...defaultAttribute,
          value: 'toto',
