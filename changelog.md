...
* Plugin management:
  * Work with [terrator-plugin](https://github.com/ditrit/terrator-plugin/tree/0.4.0) version 0.4.0.
...
* Fix bug on deleted files while pushing a branch or using "upload to git" button
