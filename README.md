...
npm run plugin:install -- repository-name="terrator-plugin" repository-url="https://github.com/ditrit/terrator-plugin.git#0.1.5"
```
...
- repository url: `https://github.com/ditrit/terrator-plugin.git#0.1.5`
